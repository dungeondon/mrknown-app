        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
                ...
                {Array.from({ length: THUMBNAIL_COUNT }, (_, i) => (
                  <button
                    ...
                    className={`relative flex-1 aspect-square rounded-xl overflow-hidden border-2 transition-all ${
                      i === 0 ? 'border-orange-400' : 'border-gray-100 hover:border-gray-300'
                    }`}
                  >
                    <Image
                      src={product.image_url}
          ...
          <div>
            ...
            <div className="flex items-center gap-1.5 mb-3" aria-label={`Rating: ${product.rating} out of 5`}>
              ...
              <span className="text-sm text-gray-400">({product.review_count.toLocaleString()})</span>
            </div>
            ...
            {/* About */}
            <div className="mb-6">
              <h2 className="text-sm font-bold text-gray-900 mb-1.5">About this product</h2>
            ...
            {(product.pros?.length > 0 || product.cons?.length > 0) && (
              <div className="grid grid-cols-2 gap-4 mb-6">
                {product.pros?.length > 0 && (
                  <div>
                    <h2 className="text-sm font-bold text-gray-900 mb-2">Pros</h2>
                ...
                {product.cons?.length > 0 && (
                  <div>
                    <h2 className="text-sm font-bold text-gray-900 mb-2">Cons</h2>
                    <ul className="space-y-1.5">
            ...
            {product.specs && Object.keys(product.specs).length > 0 && (
              <div className="mb-6">
                <h2 className="text-sm font-bold text-gray-900 mb-3">Specifications</h2>
      ...
      {related.length > 0 && (
        <div className="border-t border-gray-100 mt-4 pt-10 pb-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <h2 className="text-xl font-extrabold text-gray-900 mb-6">Related</h2>
